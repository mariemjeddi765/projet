        ...
        <div class="col-md-3 mb-3">
            <div class="card text-center h-100">
                <div class="card-body d-flex flex-column justify-content-center">
                    ...
                    <p class="card-text">Voir les chiffres clés et graphiques des ventes.</p>
                    <a href="index.php?page=admin&action=stats" class="btn btn-primary mt-auto">Voir les stats</a>
                </div>
            </div>
        </div>
    </div>
